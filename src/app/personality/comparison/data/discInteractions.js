...
const PAIRINGS = {
  ...
  // ── D + I ──────────────────────────────────────────────────────────────────
  DI: {
    chemistry: 'Natural pairing: both move fast and want action. D provides strategic direction while I gets the room on board.',
  ...
  IC: {
    ...
    delegationTips: 'I owns idea generation, the outside relationships, and the narrative. C owns feasibility analysis, process design, and quality assurance. Neither should gate the other\'s domain.',
  },
  ...
  SS: {
    ...
    strengths: 'Operational excellence, team loyalty, and long-term sustainability. Both deliver on commitments and both care about the people they serve.',
