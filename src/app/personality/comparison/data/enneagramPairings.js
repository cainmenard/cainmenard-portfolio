...
const PAIRINGS = {
  ...
  '2-2': {
    synergies: 'Warm, supportive, and naturally attuned to each other\'s needs. Two 2s build caring work environments and are natural advocates for the humans around them.',
  ...
  '9-9': {
    synergies: 'Deeply harmonious, low-friction collaboration. Both prioritize peace and both care about maintaining the relationship. Steady, sustainable partnership.',
  ...
  '6-7': {
    ...
    communicationRules: '7: take 6\'s risk scenarios seriously before offering the positive reframe, validation first. 6: let 7 know when you\'re processing vs. actually alarmed; they need context to calibrate.',
  ...
  '2-8': {
    ...
    communicationRules: '8: express appreciation explicitly: 2 reads silence as indifference. 2: express your own needs directly, 8 respects a direct ask and is bewildered by indirect requests for care.',
  ...
  '2-9': {
    synergies: 'Highly harmonious, people-centered partnership. Both care about others\' well-being and both create warm, inclusive environments naturally.',
  ...
  '1-6': {
    ...
    underStressTogether: '1 becomes hypercritical (disintegrating to 4); 6 becomes anxious and suspicious (disintegrating to 3). Both end up feeling let down by the other\'s reliability.',
  ...
  '7-9': {
    ...
    communicationRules: '7: introduce change gradually rather than all at once, 9 needs transition time. 9: express pace preferences directly before you\'re overwhelmed; 7 is responsive to clear feedback.',
  ...
  '2-5': {
    ...
    underStressTogether: '2 disintegrates toward 8 (controlling); 5 withdraws further. The 5\'s retreat makes the 2 more demanding, the exact opposite of what brings 5 back.',
  ...
  '2-6': {
    ...
    growthTogether: '6 helps 2 develop trust that relationships can survive imperfection. 2 helps 6 feel secure through consistent, unconditional presence.',
  },
  ...
  '2-7': {
    ...
    frictionPoints: '2 focuses care on others; 7 focuses attention on experiences and possibilities. 2 may feel 7 doesn\'t slow down enough to connect. 7 may feel 2\'s emotional engagement is constraining.',
