export const RECIPES = [
  {
    ...
    attribution: "Me. I have been fine-tuning this recipe since I can remember, adjusting every time I cook it",
    ...
    steps: [
      ...
      'Chicken thighs in smoker at 300\u00B0F for 20 minutes max (not totally cooked, it finishes in the gumbo). Alt: Cook in oven at 300\u00B0F for 15-20 minutes max.',
  ...
  },
  {
    ...
    notes: [],
    steps: [
      'Melt margarine in dutch oven or microwave, then add onions, green pepper, celery, and garlic. Saut\u00E9 until soft.',
  ...
  },
  {
    ...
    notes: [],
    steps: [
      'Make broth (stock) for soup. Boil hen with enough water to cover, then add chopped onion, celery, and seasoning. When hen is tender, remove from pot.',
